...
if __name__ == '__main__':
	...
	parser.add_argument('--root', default='/path/to/data/boreas/', help='path to where Boreas sequences will be stored')
	parser.add_argument('--task', default='odometry', help='[odometry|localization|detection]')
	...
	for seq in split:
		...
		command = 'aws s3 sync s3://boreas/' + seq + ' ' + seq_root + " --exclude '*' --include 'applanix/*' --include video.mp4 --include route.html "
