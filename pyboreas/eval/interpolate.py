import argparse
import os
from pyboreas.utils.odometry import get_sequences, get_sequence_poses, \
    compute_interpolation, get_sequence_times_gt
...
if __name__ == '__main__':
    ...
    parser.add_argument('--interp', default='', type=str, help='path to interpolation output')
    ...
    # interpolate
    compute_interpolation(T_pred, times_gt, times_pred, seq_lens_gt, seq_lens_pred, seq,
                          args.interp, args.solver, args.processes)