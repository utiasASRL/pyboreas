...
def get_sequence_poses_gt(path, seq):
    ...
    for filename in seq:
        ...
        T_app_aeva =  np.loadtxt(os.path.join(path, dir, "calib/T_applanix_aeva.txt"))
        ...
        T_sr = get_inverse_tf(T_ax_app @ T_app_aeva)
...
def eval_odom(pred, gt):
    ...
    T_gt, times_gt, seq_lens_gt = get_sequence_poses_gt(gt, seq)
